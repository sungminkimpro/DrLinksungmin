								...
								<ul class="submenu">
									...
									<li class="has-submenu active">
										...
										<ul class="submenu">
											...
											<li class="active"><a href="doctor-add-blog">Add Blog</a></li>
										</ul>
									</li>
								</ul>
							</li>	
															...
															<ul class="upload-wrap">
																<li>
																	<div class=" upload-images">
																		<img alt="Blog Image" src="resources/img/img-01.jpg">
																	</div>
																</li>
																<li>
																	<div class=" upload-images">
																		<img alt="Blog Image" src="resources/img/img-02.jpg">
																	</div>
																</li>
																<li>
																	<div class=" upload-images">
																		<img alt="Blog Image" src="resources/img/img-03.jpg">
																	</div>
																</li>
															</ul>
														</div>
