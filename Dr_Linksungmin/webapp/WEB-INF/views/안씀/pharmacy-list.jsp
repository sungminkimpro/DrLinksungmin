                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="active"><a href="pharmacy-list"><i class="fe fe-vector"></i> <span>Pharmacy List</span></a></li>
							<li> 
											...
											<tbody>
													...
													<td>
														<h2 class="table-avatar">
															<a class="avatar avatar-sm mr-2" data-toggle="modal" href="#edit_specialities_details">
																<img class="avatar-img rounded-circle" src="resources/img/features/feature-01.jpg" alt="product image">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a class="avatar avatar-sm mr-2" data-toggle="modal" href="#edit_specialities_details">
																<img class="avatar-img rounded-circle" src="resources/img/features/feature-02.jpg" alt="product image">
															</a>
